 ...
 */
export function argsContainAnyKeys(args, keys) {
 ...
 */
export function argsContainAnyValues(args, tokens) {
    if (!args || !tokens || tokens.length === 0)
        return false;
 ...
 */
export function checkRequirement(requirement, input) {
    switch (requirement) {
        case "reason_present":
 ...
 */
export function requirementsSatisfied(requirements, input) {
